-- pgmq v1.12.0, vendored verbatim from
-- https://raw.githubusercontent.com/pgmq/pgmq/v1.12.0/pgmq-extension/sql/pgmq.sql
-- Installed by scripts/migrate.ts via `-- @include` in 001_extensions.sql (see docs/DECISIONS.md D-23).
