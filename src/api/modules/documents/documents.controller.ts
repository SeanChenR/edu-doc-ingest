...
import {
  CreateDocumentAcceptedDto,
  CreateDocumentDto,
} from '@/api/modules/documents/documents.dto';
...
export class DocumentsController {
  ...
  @ApiResponse({
    ...
    description:
      'VALIDATION_ERROR | IDEMPOTENCY_KEY_REQUIRED | CONTENT_SOURCE_INVALID | INVALID_STORAGE_KEY',
  })
  @ApiResponse({ status: 401, type: ErrorResponseDto, description: 'UNAUTHORIZED' })
  @ApiResponse({
    status: 404,
    type: ErrorResponseDto,
    description: 'NOT_FOUND (workspace mismatch)',
  })
